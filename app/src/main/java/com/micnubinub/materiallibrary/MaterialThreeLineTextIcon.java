 ...
 */
public class MaterialThreeLineTextIcon extends ViewGroup {
    ...
    public MaterialThreeLineTextIcon(Context context) {
        super(context);
        init();
    }

    public MaterialThreeLineTextIcon(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public MaterialThreeLineTextIcon(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void scale(final float scale) {
        post(new Runnable() {
            @Override
            public void run() {
                MaterialThreeLineTextIcon.this.setScaleX(scale);
                MaterialThreeLineTextIcon.this.setScaleY(scale);
                invalidatePoster();
            }
        });
    ...
    public void setDuration(int duration) {
        MaterialThreeLineTextIcon.duration = duration;
        animator.setDuration(duration);
    }
